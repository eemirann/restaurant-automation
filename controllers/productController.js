...
async function updateProduct(req,res) {
    try{
        ...
        const result = await pool.request()
            ...
            .input('Price', sql.Decimal(10,2), Price)
            .input('CategoryId', sql.Int, CategoryId)
            .query('UPDATE Products SET Name = @Name, Description = @Description, Price = @Price, CategoryId = @CategoryId OUTPUT INSERTED.* WHERE Id = @Id')
...
async function deleteProduct(req, res) {
    ...
    const result = await pool.request()
    .input('Id',sql.Int, id)
    .query('Update Products SET IsActive = 0 OUTPUT INSERTED.* WHERE Id = @Id');
